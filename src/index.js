  ...
  <React.StrictMode>
    <NavbarHeader />
      <div className="row">
          ...
          <Cards cardTitle="Get Current Astronomy For Location" cardSubHeader="Please Provide Full Postcode: " onclick={getWeatherForLocationProvided} imageSvg={
          ...
          <Cards cardTitle="Get Sport Events For Location" cardSubHeader="Please Provide Full Postcode: " onclick={getWeatherForLocationProvided} imageSvg={
          ...
          <Cards cardTitle="Get 3-Day Forecast for Location" cardSubHeader="Please Provide Full Postcode: " onclick={getWeatherForLocationProvided} imageSvg={
          ...
          <Cards cardTitle="Get Previous 7-Days Weather for Location" cardSubHeader="Please Provide Full Postcode: " onclick={getWeatherForLocationProvided} imageSvg={
